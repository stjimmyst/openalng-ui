...
import { GetEstimation, GetUserName, getCardColor, getBlurColor, GetStubText,GetOverallScoreText,GetBandScoreText,StringToMarkup,DefaultIeltsWriting } from '../components/functions'

const IeltsWriting = (props) => {
    const [writingResults, setWritingResults] = useState(GetEstimation('WritingIeltsEstimationResult'))
    ...
    function getCurrentAnswer() {
        ...
        if (typeof (cook) != "undefined") {
            ...
            return DefaultIeltsWriting.results.answer
        }
    }
    ...
    function updateTaskDefinition(inp) {
        Cookies.set('WritingIeltsTaskDefinition', inp);
    ...
    function getTaskDefinition() {
        let cook = Cookies.get("WritingIeltsTaskDefinition")
        if (typeof (cook) != "undefined") {
            return cook
        } else {
            return DefaultIeltsWriting.results.question
        }
    }
    ...
    async function EstimateAnswer() {
        ...
        Cookies.set('WritingIeltsEstimationResult', json);
